...
<head>
    ...
    <link rel="stylesheet" href="{{url('')}}/assets/frontend/css/owl.theme.css">
    <link rel="stylesheet" href="{{url('')}}/assets/frontend/css/animate.css">
    <link rel="stylesheet" href="{{url('')}}/assets/frontend/css/flexslider.css">
    <link rel="stylesheet" href="{{url('')}}/assets/frontend/css/pricing.css">
    ...
    <script type="text/javascript" src="{{url('')}}/assets/frontend/js/jquery.flexslider.min.js"></script>
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
                <img id="logo" src="{{url('')}}/assets/frontend/images/Logo_main.png" class="logo img-responsive">
            </a>
        </div>
...
<section id="about" class="about">
    <img src="{{url('')}}/assets/frontend/images/icons/about_color.png" class="img-responsive section-icon hidden-sm hidden-xs">
    <div class="wrapper">
...
<section id="reserve" class="reserve">
    <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{url('')}}/assets/frontend/images/icons/reserve_black.png">
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row dis-table">
...
<section class="reservation">
    <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{url('')}}/assets/frontend/images/icons/reserve_color.png">
    <div class="wrapper">
        <div class="container-fluid">
            <div class=" section-content">
                <div class="row">
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <div class="copyright text-center">
                    <p>
                        &copy; Copyright, @php echo date('Y') @endphp <a href="#">Your Website Link.</a> Theme by <a href="http://themewagon.com/"  target="_blank">ThemeWagon</a>
                    </p>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="{{url('')}}/assets/frontend/js/jquery.mixitup.min.js" ></script>
<script src="{{url('')}}/assets/frontend/js/wow.min.js"></script>
<script src="{{url('')}}/assets/frontend/js/jquery.validate.js"></script>
<script type="text/javascript" src="{{url('')}}/assets/frontend/js/jquery.hoverdir.js"></script>
